      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Sec-6 E-80 New Moradabad</a></li>
                <li><a href="#" class="py-2 d-block">+91 9760653801</a></li>
                <li><a href="#" class="py-2 d-block">official@vaibhav.in</a></li>
                <li><a href="#" class="py-2 d-block">official@vaibhav.in</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart"aria-hidden="true"></i> by <a href="https://vaibhav.in" target="_blank">Vaibhav</a>
            </p>
          </div>
        </div>
      </div>
